...
KIND_PERMS = {
    ...
    "classes":       {"read": {"admin", "instructor"}, "write": {"admin", "instructor"}},
    "courses":       {"read": {"admin", "instructor"}, "write": {"admin", "instructor"}},
    "subjects":      {"read": {"admin", "instructor"}, "write": {"admin", "instructor"}},
    "chapters":      {"read": {"admin", "instructor"}, "write": {"admin", "instructor"}},
    "students":      {"read": {"admin", "instructor"}, "write": {"admin", "instructor"}},
    "quizzes":       {"read": {"admin", "instructor"}, "write": {"admin", "instructor"}},
